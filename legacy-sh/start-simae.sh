...
BACKEND_DIR="$HOME/Documents/BussinesInteligent/SIMAE/dev-back-experience-board-v1"
FRONTEND_DIR="$HOME/Documents/BussinesInteligent/SIMAE/dev-front-experience-board-v1"
